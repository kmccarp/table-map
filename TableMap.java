...
public class TableMap<Row, Col, Content> {
  ...
  /**
   * Defines a table map. This is a two-key map. <br/>Example:
   * <pre>
   *        1    2    3    4    5    6    7
   ...
   * </pre>
   * 
   * If these are put in by (e.g.) <code>set(9, 1, 9)</code>, they can later be 
   * retrieved by <code>get(9, 1)</code> (which returns 9)
   */
  ...
  /**
   * Sets the value of the cell at <code>row, col</code> to the value given by <code>val</code>
   * 
   * @param row This is the row key of the cell
   * @param col This is the column key of the cell
   * @param val This is the value to be put in the given cell
   */
